...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ReactNativeDarkMode/ReactNativeDarkMode.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/glog/glog.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/leveldb-library/leveldb.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/nanopb/nanopb.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-music-control/react_native_music_control.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-track-player/react_native_track_player.framework"
