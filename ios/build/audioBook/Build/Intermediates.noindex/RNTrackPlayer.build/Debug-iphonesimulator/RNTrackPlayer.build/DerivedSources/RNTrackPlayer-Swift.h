...
#import "/System/Volumes/Data/Users/muganwas/Documents/Github/audioBook/node_modules/react-native-track-player/ios/RNTrackPlayer/Support/RNTrackPlayer-Bridging-Header.h"
...
SWIFT_CLASS("_TtC13RNTrackPlayer20AVPlayerItemObserver")
@interface AVPlayerItemObserver : NSObject
...
/// Observing an AVPlayers status changes.
SWIFT_CLASS("_TtC13RNTrackPlayer16AVPlayerObserver")
...
- (void)destroy;
- (void)updateOptions:(NSDictionary<NSString *, id> * _Nonnull)options resolver:(SWIFT_NOESCAPE void (^ _Nonnull)(id _Nullable))resolve rejecter:(SWIFT_NOESCAPE void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
...
- (void)removeUpcomingTracks:(SWIFT_NOESCAPE void (^ _Nonnull)(id _Nullable))resolve rejecter:(SWIFT_NOESCAPE void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
...
- (void)reset:(SWIFT_NOESCAPE void (^ _Nonnull)(id _Nullable))resolve rejecter:(SWIFT_NOESCAPE void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
- (void)play:(SWIFT_NOESCAPE void (^ _Nonnull)(id _Nullable))resolve rejecter:(SWIFT_NOESCAPE void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
- (void)pause:(SWIFT_NOESCAPE void (^ _Nonnull)(id _Nullable))resolve rejecter:(SWIFT_NOESCAPE void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
- (void)stop:(SWIFT_NOESCAPE void (^ _Nonnull)(id _Nullable))resolve rejecter:(SWIFT_NOESCAPE void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
- (void)seekTo:(double)time resolver:(SWIFT_NOESCAPE void (^ _Nonnull)(id _Nullable))resolve rejecter:(SWIFT_NOESCAPE void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
- (void)setVolume:(float)level resolver:(SWIFT_NOESCAPE void (^ _Nonnull)(id _Nullable))resolve rejecter:(SWIFT_NOESCAPE void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
...
- (void)setRate:(float)rate resolver:(SWIFT_NOESCAPE void (^ _Nonnull)(id _Nullable))resolve rejecter:(SWIFT_NOESCAPE void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
...
- (void)updateMetadataForTrack:(NSString * _Nonnull)trackId properties:(NSDictionary<NSString *, id> * _Nonnull)properties resolver:(SWIFT_NOESCAPE void (^ _Nonnull)(id _Nullable))resolve rejecter:(SWIFT_NOESCAPE void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
